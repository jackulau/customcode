export const dict = {
  ...
  "settings.general.row.sidebarPosition.description": "Choose which side to display the files and changes panel",
  "settings.general.row.sidebarPosition.left": "Left",
  "settings.general.row.sidebarPosition.right": "Right",
