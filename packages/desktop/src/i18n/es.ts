export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de CustomCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de CustomCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de CustomCode. Intenta reinstalar la aplicación de escritorio.",
