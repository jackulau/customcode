export const dict = {
  ...
  "desktop.menu.help.documentation": "CustomCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of CustomCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "CustomCode CLI binary is missing. Try reinstalling the desktop app.",
