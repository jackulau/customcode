export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CustomCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "CustomCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "CustomCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
