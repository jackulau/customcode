export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの CustomCode を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "CustomCode のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.menu.help.documentation": "CustomCode ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "CustomCode CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
