export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CustomCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das CustomCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
