export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من CustomCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من CustomCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق CustomCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف CustomCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
