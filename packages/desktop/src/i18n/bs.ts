export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CustomCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CustomCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "CustomCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka CustomCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
