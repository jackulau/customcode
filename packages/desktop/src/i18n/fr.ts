export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'CustomCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'CustomCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI CustomCode est manquant. Essayez de réinstaller l'application de bureau.",
