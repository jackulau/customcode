export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} CustomCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja CustomCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego CustomCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
