export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CustomCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "CustomCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "CustomCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
