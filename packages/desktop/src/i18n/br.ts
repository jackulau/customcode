export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do CustomCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do CustomCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do CustomCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do CustomCode está ausente. Tente reinstalar o aplicativo de desktop.",
